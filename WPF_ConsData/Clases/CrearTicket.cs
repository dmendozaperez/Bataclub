...
namespace Epson_Ticket
{
    ...
    public class CrearTicket
    {
        ...
        public static Boolean _esta_imp { set; get; }
        ...
        public void EncabezadoVenta(string _cab)
        {
            //Escribimos los espacios para mostrar el articulo. En total tienen que ser 40 caracteres
            linea.AppendLine(_cab);
            //linea.AppendLine("ARTÍCULO            |CANT|PRECIO|IMPORTE");
        }
        public void AgregarItems(string _items)
        {
            //Escribimos los espacios para mostrar el articulo. En total tienen que ser 40 caracteres
            linea.AppendLine(_items);
            //linea.AppendLine("ARTÍCULO            |CANT|PRECIO|IMPORTE");
        }
        public void AgregarFooter(string _footer)
        {
            //Escribimos los espacios para mostrar el articulo. En total tienen que ser 40 caracteres
            linea.AppendLine(_footer);
            //linea.AppendLine("ARTÍCULO            |CANT|PRECIO|IMPORTE");
        }
