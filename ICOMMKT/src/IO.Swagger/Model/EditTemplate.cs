...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EditTemplate :  IEquatable<EditTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EditTemplate" /> class.
        /// </summary>
        ...
        public EditTemplate(string name = default(string), string subject = default(string), string textBody = default(string), string htmlBody = default(string), string alias = default(string))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as EditTemplate);
        }

        /// <summary>
        /// Returns true if EditTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of EditTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EditTemplate input)
        {
            if (input == null)
                return false;
