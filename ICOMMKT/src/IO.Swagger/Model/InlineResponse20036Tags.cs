...
{
    /// <summary>
    /// InlineResponse20036Tags
    /// </summary>
    [DataContract]
    public partial class InlineResponse20036Tags :  IEquatable<InlineResponse20036Tags>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20036Tags" /> class.
        /// </summary>
        /// <param name="iD">iD.</param>
        /// <param name="matchName">matchName.</param>
        /// <param name="trackOpens">trackOpens.</param>
        public InlineResponse20036Tags(int? iD = default(int?), string matchName = default(string), bool? trackOpens = default(bool?))
        {
            this.ID = iD;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20036Tags {\n");
        ...
        {
            return this.Equals(input as InlineResponse20036Tags);
        }

        /// <summary>
        /// Returns true if InlineResponse20036Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20036Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20036Tags input)
        {
            if (input == null)
                return false;
