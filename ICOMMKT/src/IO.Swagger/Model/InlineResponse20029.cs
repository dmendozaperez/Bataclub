...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse20029 :  IEquatable<InlineResponse20029>, IValidatableObject
    {
        ...
        public InlineResponse20029(List<InlineResponse20029Days> days = default(List<InlineResponse20029Days>), int? desktop = default(int?), int? mobile = default(int?), int? unknown = default(int?), int? webMail = default(int?))
        {
            this.Days = days;
        ...
        public List<InlineResponse20029Days> Days { get; set; }
