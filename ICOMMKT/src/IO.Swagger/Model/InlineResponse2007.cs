...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        public InlineResponse2007(List<InlineResponse2007Templates> templates = default(List<InlineResponse2007Templates>), int? totalCount = default(int?))
        {
        ...
        public List<InlineResponse2007Templates> Templates { get; set; }
