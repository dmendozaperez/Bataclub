...
{
    /// <summary>
    /// InlineResponse20022Clicks
    /// </summary>
    [DataContract]
    public partial class InlineResponse20022Clicks :  IEquatable<InlineResponse20022Clicks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20022Clicks" /> class.
        /// </summary>
        /// <param name="clickLocation">clickLocation.</param>
        /// <param name="_client">_client.</param>
        /// <param name="oS">oS.</param>
        /// <param name="platform">platform.</param>
        /// <param name="userAgent">userAgent.</param>
        /// <param name="originalLink">originalLink.</param>
        /// <param name="geo">geo.</param>
        /// <param name="messageID">messageID.</param>
        /// <param name="receivedAt">receivedAt.</param>
        /// <param name="tag">tag.</param>
        /// <param name="recipient">recipient.</param>
        public InlineResponse20022Clicks(string clickLocation = default(string), List<InlineResponse20020Client> _client = default(List<InlineResponse20020Client>), List<InlineResponse20020OS> oS = default(List<InlineResponse20020OS>), string platform = default(string), string userAgent = default(string), string originalLink = default(string), List<InlineResponse20020Geo> geo = default(List<InlineResponse20020Geo>), string messageID = default(string), string receivedAt = default(string), string tag = default(string), string recipient = default(string))
        {
        ...
        {
            return this.Equals(input as InlineResponse20022Clicks);
        }

        /// <summary>
        /// Returns true if InlineResponse20022Clicks instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20022Clicks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20022Clicks input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ClickLocation == input.ClickLocation ||
                    (this.ClickLocation != null &&
                    this.ClickLocation.Equals(input.ClickLocation))
                ) && 
                (
                ...
                (
                    ...
                    this.OriginalLink.Equals(input.OriginalLink))
                ) && 
                (
                    this.Geo == input.Geo ||
                    this.Geo != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ClickLocation != null)
                    hashCode = hashCode * 59 + this.ClickLocation.GetHashCode();
                ...
                if (this.OriginalLink != null)
                    hashCode = hashCode * 59 + this.OriginalLink.GetHashCode();
                if (this.Geo != null)
