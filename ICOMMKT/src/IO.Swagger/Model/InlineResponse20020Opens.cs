...
{
    /// <summary>
    /// InlineResponse20020Opens
    /// </summary>
    [DataContract]
    public partial class InlineResponse20020Opens :  IEquatable<InlineResponse20020Opens>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20020Opens" /> class.
        /// </summary>
        ...
        /// </summary>
        [DataMember(Name="FirstOpen", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20020Opens {\n");
        ...
        {
            return this.Equals(input as InlineResponse20020Opens);
        }

        /// <summary>
        /// Returns true if InlineResponse20020Opens instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20020Opens to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20020Opens input)
        {
            if (input == null)
                return false;
