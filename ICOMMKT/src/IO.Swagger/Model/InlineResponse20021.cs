...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse20021 :  IEquatable<InlineResponse20021>, IValidatableObject
    {
        ...
        public InlineResponse20021(List<InlineResponse20021Opens> opens = default(List<InlineResponse20021Opens>), int? totalCount = default(int?))
        {
            this.Opens = opens;
        ...
        public List<InlineResponse20021Opens> Opens { get; set; }
