...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailBody :  IEquatable<EmailBody>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="htmlBody">If TextBody is not specified HTML email message (required).</param>
        /// <param name="textBody">If HtmlBody is not specified Plain text email message. (required).</param>
        ...
        public EmailBody(string from = default(string), string to = default(string), string cc = default(string), string bcc = default(string), string subject = default(string), string tag = default(string), string htmlBody = default(string), string textBody = default(string), string replyTo = default(string), string headers = default(string), bool? trackOpens = default(bool?), TrackLinksEnum? trackLinks = default(TrackLinksEnum?), List<> attachments = default(List<>))
        {
            ...
            if (from == null)
            {
                throw new InvalidDataException("from is a required property for EmailBody and cannot be null");
            }
            else
            {
                this.From = from;
            ...
            if (to == null)
            {
                throw new InvalidDataException("to is a required property for EmailBody and cannot be null");
            }
            else
            {
                this.To = to;
            ...
            if (htmlBody == null)
            {
                throw new InvalidDataException("htmlBody is a required property for EmailBody and cannot be null");
            }
            else
            {
            ...
            if (textBody == null)
            {
                throw new InvalidDataException("textBody is a required property for EmailBody and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EmailBody);
        }

        /// <summary>
        /// Returns true if EmailBody instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailBody input)
        {
            if (input == null)
                return false;
