...
{
    /// <summary>
    /// InlineResponse20011HtmlBody
    /// </summary>
    [DataContract]
    public partial class InlineResponse20011HtmlBody :  IEquatable<InlineResponse20011HtmlBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011HtmlBody" /> class.
        /// </summary>
        ...
        public InlineResponse20011HtmlBody(bool? contentIsValid = default(bool?), List<> validationErrors = default(List<>), string renderedContent = default(string))
        {
        ...
        {
            return this.Equals(input as InlineResponse20011HtmlBody);
        }

        /// <summary>
        /// Returns true if InlineResponse20011HtmlBody instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011HtmlBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011HtmlBody input)
        {
            if (input == null)
                return false;
