...
{
    /// <summary>
    /// InlineResponse20011TextBody
    /// </summary>
    [DataContract]
    public partial class InlineResponse20011TextBody :  IEquatable<InlineResponse20011TextBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011TextBody" /> class.
        /// </summary>
        ...
        public InlineResponse20011TextBody(bool? contentIsValid = default(bool?), List<InlineResponse20011ValidationErrors> validationErrors = default(List<InlineResponse20011ValidationErrors>), string renderedContent = default(string))
        {
        ...
        public List<InlineResponse20011ValidationErrors> ValidationErrors { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20011TextBody {\n");
        ...
        {
            return this.Equals(input as InlineResponse20011TextBody);
        }

        /// <summary>
        /// Returns true if InlineResponse20011TextBody instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011TextBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011TextBody input)
        {
            if (input == null)
                return false;
